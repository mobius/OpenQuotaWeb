// Shared, platform-agnostic modules. These are reused by both the desktop app
...
// Desktop-only modules (Tauri application shell).
#[cfg(feature = "desktop")]
mod commands;
#[cfg(feature = "desktop")]
...
#[cfg(feature = "desktop")]
mod refresh_loop;
#[cfg(all(feature = "desktop", any(not(target_os = "macos"), test)))]
mod tray_icon;
#[cfg(feature = "desktop")]
...
#[cfg(feature = "desktop")]
mod window;
#[cfg(all(feature = "desktop", any(target_os = "linux", test)))]
mod xdg_autostart;
...
use crate::{
    ...
    providers::{
        ...
        codex::CodexProvider, copilot::CopilotProvider, cursor, deepseek::DeepSeekProvider,
